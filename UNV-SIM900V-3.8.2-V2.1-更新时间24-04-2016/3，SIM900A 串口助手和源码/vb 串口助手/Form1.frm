...
Begin VB.Form Form1 
   ...
   Begin VB.Frame Frame2 
      ...
      Top             =   8280
      Width           =   8295
      Begin VB.CommandButton Cmd_gprs_show 
         Caption         =   "打开GPRS调试"
         Height          =   375
         Left            =   6840
         TabIndex        =   40
         ...
         Width           =   1335
      End
      Begin VB.CommandButton Cmd_gprsstatus 
         Caption         =   "查看GPRS状态"
         Height          =   375
         Left            =   5400
         TabIndex        =   39
         ...
         Width           =   1335
      End
      Begin VB.CommandButton CMD_NETSTA 
         Caption         =   "网络状态"
         Height          =   375
         Left            =   4080
         TabIndex        =   28
         ...
         Width           =   1215
      End
      Begin VB.CommandButton Cmd_SIMSTA 
         Caption         =   "SIM卡状态"
         Height          =   375
         Left            =   2760
         TabIndex        =   27
         ...
         Width           =   1215
      End
      Begin VB.CommandButton Cmd_devicetype 
         Caption         =   "设备类型"
         Height          =   375
         Left            =   1440
         TabIndex        =   26
         ...
         Width           =   1215
      End
      Begin VB.CommandButton Cmd_changshang 
         Caption         =   "生产厂商"
         Height          =   375
         Left            =   120
         TabIndex        =   25
   ...
   Begin VB.Frame Frame1 
      Caption         =   "串口与SIM900A通信区"
      Height          =   2295
      Left            =   120
      TabIndex        =   23
      Top             =   5880
      Width           =   8295
      Begin VB.CommandButton Cmd_cls_sended 
         Caption         =   "清空已发送区"
         Height          =   375
         Left            =   2160
         TabIndex        =   38
         ...
         Width           =   1575
      End
      Begin VB.CommandButton Cmd_send1 
         Caption         =   "发送"
         Height          =   375
         Left            =   120
         TabIndex        =   37
