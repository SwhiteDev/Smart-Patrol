...
Private Sub Cmd_open_Click()
    ...
    Select Case Cmd_open.Caption
        Case "启动监听"
            ...
            Label1.Caption = "TCP SERVER 已连接"
        Case "停止监听"
            Cmd_open.Caption = "启动监听"
            Label1.Caption = "TCP CLIENT 已关闭"
            Winsock1.Close
        Case "连接GPRS"
            Cmd_open.Caption = "断开GPRS"
            Label1.Caption = "TCP CLIENT 已连接"
            Winsock1.Connect
        Case "断开GPRS"
            Cmd_open.Caption = "连接GPRS"
            Label1.Caption = "TCP CLIENT 已关闭"
